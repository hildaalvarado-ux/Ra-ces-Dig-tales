...
class _PreparacionSueloPageState extends State<PreparacionSueloPage> {
  ...
  void _createNewPreparation() async {
    // Show dialog to select crop (optional)
    String? selectedCrop;
    ...
    if (result != null) {
      // Create initial tasks from catalog
    ...
    return AppBackground(
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: const Text('NUEVA PREPARACIÓN', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        ),
      ),
    );
  }
...
class _TaskCard extends StatelessWidget {
  ...
  const _TaskCard({required this.task, required this.onSelect, required this.onInfo});
